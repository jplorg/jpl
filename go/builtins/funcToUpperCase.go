...
var funcToUpperCase = enclose(func(runtime jpl.JPLRuntime, signal jpl.JPLRuntimeSignal, next jpl.JPLPiper, input any, args ...any) ([]any, error) {
	...
	return nil, library.ThrowAny(library.NewTypeError("%s (%*<100v) cannot be converted to upper case", string(t), u))
})
